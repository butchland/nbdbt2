# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/00_dbt_cellmagic.ipynb.

# %% auto 0
__all__ = ['nbdbt_config', 'clear_cache', 'config_dbt', 'DbtMagicObject', 'write_dbt']

# %% ../nbs/00_dbt_cellmagic.ipynb 5
import IPython
from IPython.core import magic_arguments
from IPython.core.magic import register_cell_magic, register_line_magic

# %% ../nbs/00_dbt_cellmagic.ipynb 6
from pathlib import Path
from typing import Union, List, Dict, Optional
import os
import shutil

# %% ../nbs/00_dbt_cellmagic.ipynb 7
IN_NBDBT_TEST = os.environ.get("IN_NBDBT_TEST", "False").lower() == "true"
NBDBT_DEBUG = False

# %% ../nbs/00_dbt_cellmagic.ipynb 8
from fastcore.all import patch

# %% ../nbs/00_dbt_cellmagic.ipynb 9
